<template><div><p>Yearning does not rely on any third-party SQL auditing tools as its auditing engine; it has internally implemented audit/rollback-related logic.</p>
<p><strong>Only depends on the MySQL database.</strong></p>
<p>The MySQL version must be <strong>5.7</strong> or above (for 8.0 and above, set <code v-pre>sql_mode</code> to empty) and should be pre-installed with the <strong>Yearning database created</strong>, with the character set set to <strong>UTF8mb4</strong> (only required for the MySQL version Yearning needs).</p>
...
<p>For overlapping issues on the settings page, please confirm your resolution and check for any zoom operations.</p>
...
<p><strong>Please select the latest version and download the Yearning-x.x.x.linux-amd64.zip package from the Assets section.</strong></p>
<p><strong>If you wish to modify the code or compile it yourself, please visit the <a href="">Secondary Development Page</a>.</strong></p>
...
<p><img src="https://wuchen-1252812685.cos.ap-shanghai.myqcloud.com/img/yearning/20210301141132.png" alt="Yearning Directory Structure"></p>
...
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">LogLevel</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D"> =</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77"> "</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">debug</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">"</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  # Options: debug, info, warn, error - Choose the log display level</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">Lang</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D"> =</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77"> "</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">en_US</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">"</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  # Options: en_US, zh_CN - Choose the language for Yearning</span></span></code></pre>
...
<p>The SecretKey is used as a salt for token/database password encryption/decryption.</p>
<p>It is recommended to change the SecretKey before initially installing Yearning (failing to change it may pose a security risk).</p>
<p><strong>Format: Both uppercase and lowercase letters are allowed, and the length must be 16 characters. If the length is not 16 characters, it will result in the inability to create new data sources.</strong></p>
<p><strong>Important Note:</strong></p>
<p><strong>This key can only be changed during the initial installation! It cannot be changed afterward! Changing it later will cause the existing data source passwords to be undecryptable, ultimately leading to the inability to access related data source information.</strong></p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><img src="https://wuchen-1252812685.cos.ap-shanghai.myqcloud.com/img/yearning/20210301141137.jpg" alt="Yearning Help"></p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><strong>If you need to reinstall, please delete all tables under the yearning database first; otherwise, repeated execution is ineffective.</strong></p>
...
<p>Please Note:</p>
<p>Due to the use of WebSocket communication in some functions in Yearning, if accessing Yearning through reverse proxy, please ensure WebSocket protocol support at the proxy layer.</p>
<p>For example: For NGINX, configure <code v-pre>proxy_http_version 1.1</code>; <code v-pre>proxy_set_header Upgrade $http_upgrade</code>; <code v-pre>proxy_set_header Connection &quot;upgrade&quot;;</code></p>
</div>
...
<span class="line"><span>Open a browser and go to http://127.0.0.1:8000</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/dash01.png" alt="Yearning Dashboard"></p>
</div></template>
