import{_ as n,c as s}from"./app.bb4f31aa.js";const a={},e=s(`<h1 id="yearning-go" tabindex="-1"><a class="header-anchor" href="#yearning-go" aria-hidden="true">#</a> Yearning-go</h1><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>|-- Yearning
    |-- .gitignore
    |-- Juno
    |-- LICENSE
    |-- README.md
