import{_ as p,r as t,o as l,a as c,b as n,d as o,F as r,c as s,e as a}from"./app.4722cc40.js";const u={},k=s(`<h1 id="docker-k8s" tabindex="-1"><a class="header-anchor" href="#docker-k8s" aria-hidden="true">#</a> Docker &amp; K8s</h1><h2 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> Docker</h2><h3 id="\u6CE8\u610F" tabindex="-1"><a class="header-anchor" href="#\u6CE8\u610F" aria-hidden="true">#</a> \u6CE8\u610F</h3><p>Yearning\u5B89\u88C5\u5305\u5185\u5DF2\u542B\u6709Dockerfile\u6587\u4EF6,\u53EF\u76F4\u63A5\u8FDB\u884Cbuild\u6253\u5305\u6210\u955C\u50CF</p><p><strong>Yearning \u4ECEv2.0.4\u7248\u672C\u5F00\u59CB\u652F\u6301\u73AF\u5883\u53D8\u91CF\u4F20\u53C2</strong></p><p>\u5BB9\u5668\u542F\u52A8\u65F6\u53EF\u901A\u8FC7\u73AF\u5883\u53D8\u91CF\u7684\u65B9\u5F0F\u4F20\u5165\u6570\u636E\u5E93\u5730\u5740\u3002</p><p>\u5982\u4E0B\u6240\u793A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d -it -p8000:8000 -e <span class="token assign-left variable">MYSQL_USER</span><span class="token operator">=</span>root -e <span class="token assign-left variable">MYSQL_ADDR</span><span class="token operator">=</span><span class="token number">10.0</span>.0.3:3306 -e <span class="token assign-left variable">MYSQL_PASSWORD</span><span class="token operator">=</span><span class="token number">123123</span> -e <span class="token assign-left variable">MYSQL_DB</span><span class="token operator">=</span>Yearning test/yearning
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="k8s" tabindex="-1"><a class="header-anchor" href="#k8s" aria-hidden="true">#</a> K8s</h2>`,9),i=a("k8s\u90E8\u7F72\u53C2\u8003"),b={href:"https://zhuanlan.zhihu.com/p/408504679",target:"_blank",rel:"noopener noreferrer"},m=a("K8S | \u90E8\u7F72 Yearning SQL \u5BA1\u6838\u5E73\u53F0"),y=s(`<h4 id="secret" tabindex="-1"><a class="header-anchor" href="#secret" aria-hidden="true">#</a> Secret</h4><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
...
<span class="token key atrule">data</span><span class="token punctuation">:</span>   <span class="token comment"># \u8FD9\u91CC\u914D\u7F6E\u7684\u662F\u6570\u636E\u5E93\u7684\u76F8\u5173\u4FE1\u606F\uFF0C\u4F7F\u7528base64\u52A0\u5BC6\u8F93\u5165\uFF1A</span>
  ...
  <span class="token key atrule">data</span><span class="token punctuation">:</span> WWVhcm5pbmc=    <span class="token comment"># echo -n &#39;Yearning&#39; | base64</span>
...
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">name</span><span class="token punctuation">:</span> yearing
  <span class="token key atrule">namespace</span><span class="token punctuation">:</span> zheng
<span class="token key atrule">spec</span><span class="token punctuation">:</span>
  <span class="token key atrule">rules</span><span class="token punctuation">:</span>
    <span class="token comment"># \u9700\u8981\u5728\u672C\u5730\u673A\u5668\u7684hosts\u6587\u4EF6\u4E2D\u6DFB\u52A0\u914D\u7F6E\uFF1A192.168.111.111 www.yearning.com</span>
    <span class="token punctuation">-</span> <span class="token key atrule">host</span><span class="token punctuation">:</span> www.yearning.com
...
<span class="token key atrule">metadata</span><span class="token punctuation">:</span> <span class="token comment"># \u5143\u6570\u636E</span>
  <span class="token key atrule">labels</span><span class="token punctuation">:</span> <span class="token comment"># \u6807\u7B7E</span>
    <span class="token key atrule">app</span><span class="token punctuation">:</span> SQL<span class="token punctuation">-</span>Review
  ...
  <span class="token key atrule">template</span><span class="token punctuation">:</span> <span class="token comment"># \u955C\u50CF\u7684\u6A21\u677F</span>
    ...
    <span class="token key atrule">spec</span><span class="token punctuation">:</span>
      <span class="token key atrule">containers</span><span class="token punctuation">:</span> <span class="token comment"># \u5BB9\u5668\u4FE1\u606F</span>
        <span class="token punctuation">-</span> <span class="token key atrule">image</span><span class="token punctuation">:</span> 192.168.189.111/project/yearning  <span class="token comment"># \u5BB9\u5668\u955C\u50CF</span>
